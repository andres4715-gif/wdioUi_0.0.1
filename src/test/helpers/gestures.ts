...
class Gestures {
     ...
     * @param {number} amount
     */
    static checkIfDisplayedWithScrollDown (element: any, maxScrolls: any, amount = 0) {
     ...
     * </pre>
     */
    static swipeOnPercentage (from: any, to: any) {
     ...
     * @private
     */
    static _getDeviceScreenCoordinates (screenSize: any, coordinates: any) {
        return {
     ...
     * @private
     */
    static _calculateXY ({ x, y }: any, percentage: number) {
        return {
            x: x * percentage,
            y: y * percentage,
        };
